...
傳教士羅馬字中將 kw、kwʽ、gw、ngw、w̆、hw、w 分析爲聲母，取消了除 u、un 外所有合口呼韻母。也可以將這些音節分析爲 k、kʽ、g、ng、∅、h、ʽ 聲母加上合口呼韻母。這樣分析，音系裏會增加 wa、wô、wæ、we、wæn、wang、wông、weng、wah、wôh、weh 這 11 個合口呼韻母。

## 聲調

清末寧波話可能存在 8 個聲調，但傳教士羅馬字並不標註聲調。
